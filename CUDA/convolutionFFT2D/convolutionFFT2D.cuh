...
//
// 
//convertUShort2Float- convert short array to float array.
//
////////////////////////////////////////////////////////////////////////////////

//!! Tim Madden
__global__ void convertUShort2Float_k(
    float *d_Dst,
...
//!! Tim Madden
__global__ void convertFloat2UShort_k(
    ...
    d_Dst[i] = (unsigned short)d_Src[i];
}
...
//!! Tim Madden
__global__ void multGainImage_k(
    float *d_Dst,
    float *d_Src,
    float *d_GImg,
    int dataSize
...
//!! Tim Madden
__global__ void subtractDarkImage_k(
    float *d_Dst,
    float *d_Src,
    float *d_DImg,
    int dataSize
...
//!! Tim Madden
__global__ void shortImg2rgbImage_k(
     int *d_Dst,
     short *d_Src,
    int dataSize,
     float bright_gain,
   ...
   aa = bright_gain *aa  + bright_offset;
   aa=aa/256;
...
//!! Tim Madden
__global__ void floatImg2rgbImage_k(
     int *d_Dst,
     float *d_Src,
    int dataSize
