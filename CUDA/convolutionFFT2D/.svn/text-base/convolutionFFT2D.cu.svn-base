...
////////////////////////////////////////////////////////////////////////////////
////////////////////////////////////////////////////////////////////////////////
extern "C" void convertUShort2Float(
    float *d_Dst,
	...
	)
{
    ...
    convertUShort2Float_k<<<iDivUp(dataSize, 256), 256>>>(
        d_Dst,
        d_Src,
        dataSize);
    cutilCheckMsg("convertUShort2Float() execution failed\n");
}


////////////////////////////////////////////////////////////////////////////////
////////////////////////////////////////////////////////////////////////////////
extern "C" void convertFloat2UShort(
	...
	)
{
    ...
    convertFloat2UShort_k<<<iDivUp(dataSize, 256), 256>>>(
        d_Dst,
        d_Src,
        dataSize);
    cutilCheckMsg("convertFloat2UShort() execution failed\n");
}
...
extern "C" void subtractDarkImage(
    float *d_Dst,
    float *d_Src,
    float *d_DImg,
    int fftH,
	...
	)
{
    ...
    subtractDarkImage_k<<<iDivUp(dataSize, 256), 256>>>(
        d_Dst,
        d_Src,
        d_DImg,
        dataSize);
    cutilCheckMsg("subtractDarkImage() execution failed\n");
}




extern "C" void multGainImage(
    float *d_Dst,
    float *d_Src,
    float *d_GImg,
    int fftH,
	...
	)
{
    ...
    multGainImage_k<<<iDivUp(dataSize, 256), 256>>>(
        d_Dst,
        d_Src,
        d_GImg,
        dataSize);
    cutilCheckMsg("multGainImage() execution failed\n");
}	
...
extern "C" void shortImg2rgbImage(
     int *d_Dst,
     short *d_Src,
    int H,
    int W,
...
{
    const int dataSize = H * W;

    shortImg2rgbImage_k<<<iDivUp(dataSize, 256), 256>>>(
        d_Dst,
        d_Src,
        dataSize,
        bright_gain,
        bright_offset);
    cutilCheckMsg("shortImg2rgbImage() execution failed\n");
}	
...
extern "C" void floatImg2rgbImage(
     int *d_Dst,
     float *d_Src,
    int H,
    int W
	...
	)
{
    ...
    floatImg2rgbImage_k<<<iDivUp(dataSize, 256), 256>>>(
        d_Dst,
        d_Src,
        dataSize);
    cutilCheckMsg("floatImg2rgbImage() execution failed\n");
}	
