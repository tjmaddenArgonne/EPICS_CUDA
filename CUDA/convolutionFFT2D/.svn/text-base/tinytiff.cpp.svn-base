...
//
//////////////////////////////////////////////////////
void tinytiff::tifIFD(char* filename,unsigned long offset)
{
...
void tinytiff::tifIFD(HANDLE fp,unsigned long offset)
{
  unsigned long ifdlen;
  bool is_tiff;
  unsigned long got;
...
unsigned long tinytiff::tifFindIFD(void)
{
	...
	int sizey)
{
	...
	else
	{
		...
		next_ifd+=sizeof(long);// long at end of THIOS image ifd
		next_ifd+=sizeof(short);// long at beg of THIOS image ifd
